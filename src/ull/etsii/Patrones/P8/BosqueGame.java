...
public class BosqueGame extends BasicGameState{
	...
	public void init(GameContainer container, StateBasedGame game)
		...
		this.game = game;
		JL = new LaberintoBosqueFactory();
		L1 = JL.crearLaberinto();
		HabitacionSalida = 5;
		HabitacionMonstruo = 3;
	...
	public void render(GameContainer container, StateBasedGame SBG, Graphics g)
        ...
        if(H1.Ubicacion.equals(L1.numeroDeHabitacion(HabitacionMonstruo)) && M1.HP > 0)
        	container.getGraphics().drawString("¡¡Combate!! (Ir a la consola)", 200, 200);
